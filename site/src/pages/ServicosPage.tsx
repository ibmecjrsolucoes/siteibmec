...
function ProdutoCard({ produto }: { produto: Produto }) {
  ...
  return (
    <div className="sp-card">
      ...
      <a
        href={`https://wa.me/5522988329121?text=${mensagem}`}
        target="_blank"
      ...
      <main className="sp-main">
        ...
        <section className="sp-cta">
          <div className="container sp-cta__inner">
            ...
            <a
              href="https://wa.me/5522988329121?text=Olá%2C%20gostaria%20de%20fazer%20um%20diagnóstico%20gratuito%20com%20a%20IBMEC%20Jr."
              target="_blank"
              rel="noopener noreferrer"
