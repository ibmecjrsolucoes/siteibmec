      ...
      <div className="container">
        <div className="footer__grid">
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              <li><a href="#servicos">Plano Estratégico</a></li>
              <li><a href="#servicos">Plano de Marketing</a></li>
              <li><a href="#servicos">Mapeamento de Processos</a></li>
              <li><a href="#servicos">Pesquisa de Clientes</a></li>
              <li><a href="#servicos">Análise de Dados</a></li>
              <li><a href="#servicos">Desenvolvimento de Software</a></li>
            </ul>
          </div>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              <li>
                <a href="mailto:comercial@ibmecjr.com.br">
                  comercial@ibmecjr.com.br
                </a>
              </li>
              <li>
